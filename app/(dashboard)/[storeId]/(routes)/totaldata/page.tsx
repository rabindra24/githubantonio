...
import { getSalesCount, getSalesCountForAllStore } from "@/actions/get-sales-count";
import { getStockCount } from "@/actions/get-stock-count";
import { getTotalRevenue, getTotalRevenueForAllStore } from "@/actions/get-total-revenue";
...
import {  getTotalYearGraphRevenueForAllStore } from "@/actions/get-total-year-graph-revenue";
...
const DashboardPage: React.FC<DashboardPageProps> = async ({ params }) => {
  ...
  const totalRevenue = await getTotalRevenueForAllStore(params.storeId, id);
  const salesCount = await getSalesCountForAllStore(params.storeId, id);
  ...
  const graphTotalYearRevenue = await getTotalYearGraphRevenueForAllStore(params.storeId);
  ...
  return (
    <div className="flex-col">
      <div className="flex-1 p-8 pt-6 space-y-4">
        <Heading title="Total Sales" description="Overview of your all store" />
        <Separator />
